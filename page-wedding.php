...
<section class="intro">
    <div class="intro__container">
        ...
        <?php } ?>
        <h2 class="text-header" data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease-in-out"><?php echo $intros['intro_title']; ?></h2>
        <div data-aos="fade-up" data-aos-delay="150" data-aos-easing="ease-in-out"><?php echo $intros['intro_text']; ?></div>
    </div>
</section>
<!-- EOF Section Intro -->
...
<section class="profile profile--groom">
    ...
    <div class="profile__details">
        <figure class="profile__picture" data-aos="fade-up" data-aos-delay="50" data-aos-easing="ease-in-out">
            <img src="<?php echo $section_groom['profile_picture']['url']; ?>" alt="Profile picture groom" aria-hidden="true" loading="lazy">
        </figure>
            ...
            <?php if ($section_groom['socials']) { ?>
                <ul class="profile__info__socials">
                    <?php if ($section_groom['socials']['instagram']) { ?>
                        <li data-aos="fade-up" data-aos-delay="250" data-aos-easing="ease-in-out"><a href="<?php echo $section_groom['socials']['instagram']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-instagram social-ig"></i></a></li>
                    <?php } ?>
                    <?php if ($section_groom['socials']['facebook']) { ?>
                        <li data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-in-out"><a href="<?php echo $section_groom['socials']['facebook']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-facebook social-fb"></i></a></li>
                    <?php } ?>
                    <?php if ($section_groom['socials']['tiktok']) { ?>
                        <li data-aos="fade-up" data-aos-delay="350" data-aos-easing="ease-in-out"><a href="<?php echo $section_groom['socials']['tiktok']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-tiktok social-tiktok"></i></a></li>
                    <?php } ?>
                    <?php if ($section_groom['socials']['linkedin']) { ?>
                        <li ata-aos="fade-up" data-aos-delay="400" data-aos-easing="ease-in-out"><a href="<?php echo $section_groom['socials']['linkedin']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-linkedin-in social-linkedin"></i></a></li>
                    <?php } ?>
                </ul>
            <?php } ?>
            <hr>
...
<section class="profile profile--bride">
    ...
    <div class="profile__details">
        <figure class="profile__picture" data-aos="fade-up" data-aos-delay="50" data-aos-easing="ease-in-out">
            <img src="<?php echo $section_bride['profile_picture']['url']; ?>" alt="Profile picture bride" aria-hidden="true" loading="lazy">
        </figure>
        <div class="profile__info">
            <div class="profile__info__dob" data-aos="fade-up" data-aos-delay="100" data-aos-easing="ease-in-out">
            ...
            <?php if ($section_bride['socials']) { ?>
                <ul class="profile__info__socials">
                    <?php if ($section_bride['socials']['instagram']) { ?>
                        <li data-aos="fade-up" data-aos-delay="250" data-aos-easing="ease-in-out"><a href="<?php echo $section_bride['socials']['instagram']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-instagram social-ig"></i></a></li>
                    <?php } ?>
                    <?php if ($section_bride['socials']['facebook']) { ?>
                        <li data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease-in-out"><a href="<?php echo $section_bride['socials']['facebook']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-facebook social-fb"></i></a></li>
                    <?php } ?>
                    <?php if ($section_bride['socials']['tiktok']) { ?>
                        <li data-aos="fade-up" data-aos-delay="350" data-aos-easing="ease-in-out"><a href="<?php echo $section_bride['socials']['tiktok']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-tiktok social-tiktok"></i></a></li>
                    <?php  } ?>
                    <?php if ($section_bride['socials']['linkedin']) { ?>
                        <li data-aos="fade-up" data-aos-delay="400" data-aos-easing="ease-in-out"><a href="<?php echo $section_bride['socials']['linkedin']; ?>" target="_blank" rel="noopener"><i class="fa-brands fa-linkedin-in social-linkedin"></i></a></li>
                    <?php } ?>
                </ul>
            <?php } ?>
            <hr>
...
<section class="venue">
    <div class="venue__container">
        <div class="venue__info">
            ...
            <a href="https://goo.gl/maps/pu8Db9E6KeK4mpXTA" target="_blank" rel="noopener" class="btn btn--primary" data-aos="fade-up" data-aos-delay="200" data-aos-easing="ease-in-out"><i class="fa-solid fa-map"></i> Buka Map</a>
        </div>
        <div class="venue__map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.756699679298!2d115.32812951550515!3d-8.522986363687501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd216542cc4ede7%3A0x2308fdb0be993019!2sTaman%20Prakerti%20Bhuana!5e0!3m2!1sen!2sid!4v1680102092816!5m2!1sen!2sid" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
<!-- EOF Section Venue -->
...
<!-- Section Countdown -->
<section class="section-countdown" <?php if ($section_countdown['background_image']) { ?>style="background-image: url(<?php echo $section_countdown['background_image']['url']; ?>);" <?php } ?>>
    <div class="countdown">
...
<section class="gallery">
    ...
    <div class="grid gallery__container" id="galleries">
        ...
        <?php if ($galleries) { ?>
            ...
            ?>
                <a href="<?php echo $gallery['full_image_url']; ?>" target="_blank" class="grid-item" data-pswp-width="<?php echo $dataWidthArr[0]; ?>" data-pswp-height="<?php echo $dataWidthArr[1]; ?>" data-aos="fade-up" data-aos-delay="<?php echo $key ?>00" data-aos-easing="ease-in-out">
